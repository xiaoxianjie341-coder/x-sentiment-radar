...
def load_settings(config_path: Path | None = None, env: Mapping[str, str] | None = None) -> AppSettings:
    ...
    values: dict[str, Any] = {
        ...
        "daily_candidate_budget": DEFAULT_DAILY_CANDIDATE_BUDGET,
        ...
        "attentionvc_reply_sample_limit": 20,
        "attentionvc_top_signal_count": 5,
        "attentionvc_signal_min_views": 50,
